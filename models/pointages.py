...
from sqlalchemy import Column, Date, ForeignKey, Integer, String, Time, Enum, Float
...
class Pointage(Base):
    ...
    distance_arrivee = Column(Float, default=1) #distance entre les visages
    distance_depart = Column(Float, default=1)
